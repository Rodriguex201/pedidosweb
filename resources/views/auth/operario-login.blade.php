            ...
            <form method="POST" action="{{ route('operario.login.submit') }}" class="space-y-5" novalidate>
                ...
                <div>
                    ...
                    <select id="operario" name="operario" required
                        class="block w-full rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm shadow-sm outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
